...
for (let i = 0; i < starWarsMovies.length; i++) {
  const decade = Math.floor(starWarsMovies[i].releaseYear / 10) * 10 // las decadas de las películas

  if (!moviesByDecade[decade]) {
    //si la decada no existe dentro del objeto en forma de clave, la creamos.
